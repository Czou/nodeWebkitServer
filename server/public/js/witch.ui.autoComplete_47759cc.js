...
;(function($) {
    ...
    $.fn.witchAuto = function(options) {
        ...
        var options = $.extend(defaults, options);
			...
			var ul = $('<ul class="' + options.class + '" style="width:' + o.width() + 'px;display:block;left:'+(oOffset.left - opOffset.left)+'px;top:'+(oOffset.top - opOffset.top + o.height() + 5)+'px;" tabindex="1"></ul>');
			op.append(ul);
