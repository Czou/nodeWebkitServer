 ...
 */
  function witchDataTable(id,options) {
                ...
                success: function(msg) {
                    ...
                    for(var i=0,dl=data.length;i<dl;i++) {
                        ...
                        for(var key in data[i]) {
                            thead+='<td class="uname '+data[dk]+'">'+dk+'</td>';
                        }
                        thead += '<tr><td>'+line+'</td><td class="uname '+data[dk]+'">'+dk+'</td><td class="'+data[dk]+'">'+data[dk]+'</td><td></td></tr>';
                        _dom.data('line',++line);
        ...
        _self.addMenu=function() {
            _dom.find('tr').unbind().bind('mousedown',function(e) {
                var o=$(this);
               if( e.which === 3) {
                alert(o.html());
               }
