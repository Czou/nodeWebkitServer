...
;(function($) {
    ...
    $.fn.witchAuto = function(options) {
        ...
        var options = $.extend(defaults, options);
			...
			var left = (oOffset.left - opOffset.left);
			var top = (oOffset.top - opOffset.top + o.height() + 5);
			if(op.is('td')) {
				left = 0;
				top = 0;
			}
			var ul = $('<ul class="' + options.class + '" style="width:' + o.width() + 'px;display:none;left:'+ left +'px;top:' + top +'px;z-index:1000;" tabindex="1"></ul>');
			op.append(ul);
